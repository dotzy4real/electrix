...
import ContactImage from '../../assets/images/msmsl/contact.jpg';
                            ...
                            <div className="inner-column">
                                ...
                                <div className="experience">
                                    <div className="inner">
                                        ...
                                        <div className="text">We Provide World Best Class <br/>Metering Solution for You {/*Your Innovation, Our Precision <br/>Precision Electronics  for You */}</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="inner-column">
                                <div className="contact-form-seven wow fadeInLeft">
                                    <div className="sec-title light">
                                        ...
                                        <h2>Contact Us, Let’s Take Up Your Any Query.</h2>
                                    </div>
