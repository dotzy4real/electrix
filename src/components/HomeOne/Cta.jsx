...
import CtaImg from '../../assets/images/logo_white1.png';
                        ...
                        <div className="col-xl-7 col-lg-8">
                            <div className="outer-box">
                                <div className="title-box">
                                    <h3 className="title">Free Consultation On Your <br />Electrical Needs</h3>
                                </div>
                                <div className="btn-box">
                                    <Link to="/contact" className="theme-btn btn-style-one hvr-light"><span className="btn-title">GET SOLUTION</span></Link>
                                </div>
                            </div>
                        </div>
                    </div>
