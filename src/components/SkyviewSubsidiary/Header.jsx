...
import logo1 from '../../assets/images/SkyView-BG.png';
                ...
                <div className="header-top">
                    <div className="inner-container">
                        ...
                        <div className="top-center"> 
                            ...
                            <li><i className="far fa-location"></i> 3B Oroma Close,  Port Harcourt, Rivers State</li>
                                <li><i className="far fa-phone"></i> <Link to="tel:08033367703">08033367703</Link></li>
                            </ul>
                        </div>
                    ...
                    <div className="main-box">
                        ...
                        <div className="outer-box">
                            ...
                            <div className="btn-box">
                                {/*<Link to="/page-contact" className="theme-btn btn-style-one bg-dark"><span className="btn-title"></span></Link>*/}
                            </div>
