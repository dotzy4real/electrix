...
$kilowatt_homebanners_view = NULL; // Initialize page object first

class ckilowatt_homebanners_view extends ckilowatt_homebanners {
	...
	// Page object name
	var $PageObjName = 'kilowatt_homebanners_view';
	...
	function __construct() {
		...
		if (@$_GET["kilowatt_homebanner_id"] <> "") {
			$this->RecKey["kilowatt_homebanner_id"] = $_GET["kilowatt_homebanner_id"];
			$KeyUrl .= "&amp;kilowatt_homebanner_id=" . urlencode($this->RecKey["kilowatt_homebanner_id"]);
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["kilowatt_homebanner_id"] <> "") {
				...
				$this->RecKey["kilowatt_homebanner_id"] = $this->kilowatt_homebanner_id->QueryStringValue;
			} elseif (@$_POST["kilowatt_homebanner_id"] <> "") {
				$this->kilowatt_homebanner_id->setFormValue($_POST["kilowatt_homebanner_id"]);
				$this->RecKey["kilowatt_homebanner_id"] = $this->kilowatt_homebanner_id->FormValue;
			} else {
				$sReturnUrl = "kilowatt_homebannerslist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "kilowatt_homebannerslist.php"; // No matching record, return to list
					}
			}
		} else {
			$sReturnUrl = "kilowatt_homebannerslist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($kilowatt_homebanners_view)) $kilowatt_homebanners_view = new ckilowatt_homebanners_view();

// Page init
$kilowatt_homebanners_view->Page_Init();

// Page main
$kilowatt_homebanners_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$kilowatt_homebanners_view->Page_Render();
?>
...
var CurrentForm = fkilowatt_homebannersview = new ew_Form("fkilowatt_homebannersview", "view");

// Form_CustomValidate event
fkilowatt_homebannersview.Form_CustomValidate = 
...
fkilowatt_homebannersview.ValidateRequired = true;
<?php } else { ?>
fkilowatt_homebannersview.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fkilowatt_homebannersview.Lists["x_status"] = {"LinkField":"","Ajax":false,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fkilowatt_homebannersview.Lists["x_status"].Options = <?php echo json_encode($kilowatt_homebanners->status->Options()) ?>;
...
<?php $kilowatt_homebanners_view->ExportOptions->Render("body") ?>
<?php
	foreach ($kilowatt_homebanners_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php echo $Language->SelectionForm(); ?>
<div class="clearfix"></div>
</div>
<?php $kilowatt_homebanners_view->ShowPageHeader(); ?>
<?php
$kilowatt_homebanners_view->ShowMessage();
?>
<form name="fkilowatt_homebannersview" id="fkilowatt_homebannersview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($kilowatt_homebanners_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $kilowatt_homebanners_view->Token ?>">
<?php } ?>
...
<?php if ($kilowatt_homebanners->kilowatt_homebanner_id->Visible) { // kilowatt_homebanner_id ?>
	<tr id="r_kilowatt_homebanner_id">
		<td><span id="elh_kilowatt_homebanners_kilowatt_homebanner_id"><?php echo $kilowatt_homebanners->kilowatt_homebanner_id->FldCaption() ?></span></td>
		<td data-name="kilowatt_homebanner_id"<?php echo $kilowatt_homebanners->kilowatt_homebanner_id->CellAttributes() ?>>
<span id="el_kilowatt_homebanners_kilowatt_homebanner_id">
<span<?php echo $kilowatt_homebanners->kilowatt_homebanner_id->ViewAttributes() ?>>
<?php echo $kilowatt_homebanners->kilowatt_homebanner_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($kilowatt_homebanners->kilowatt_homebanner_icontitle->Visible) { // kilowatt_homebanner_icontitle ?>
	<tr id="r_kilowatt_homebanner_icontitle">
		<td><span id="elh_kilowatt_homebanners_kilowatt_homebanner_icontitle"><?php echo $kilowatt_homebanners->kilowatt_homebanner_icontitle->FldCaption() ?></span></td>
...
<?php echo $kilowatt_homebanners->kilowatt_homebanner_icontitle->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($kilowatt_homebanners->kilowatt_homebanner_maintitle->Visible) { // kilowatt_homebanner_maintitle ?>
	<tr id="r_kilowatt_homebanner_maintitle">
		<td><span id="elh_kilowatt_homebanners_kilowatt_homebanner_maintitle"><?php echo $kilowatt_homebanners->kilowatt_homebanner_maintitle->FldCaption() ?></span></td>
...
<?php echo $kilowatt_homebanners->kilowatt_homebanner_maintitle->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($kilowatt_homebanners->kilowatt_homebanner_subtitle->Visible) { // kilowatt_homebanner_subtitle ?>
	<tr id="r_kilowatt_homebanner_subtitle">
		<td><span id="elh_kilowatt_homebanners_kilowatt_homebanner_subtitle"><?php echo $kilowatt_homebanners->kilowatt_homebanner_subtitle->FldCaption() ?></span></td>
...
<?php echo $kilowatt_homebanners->kilowatt_homebanner_subtitle->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($kilowatt_homebanners->kilowatt_homebanner_pic->Visible) { // kilowatt_homebanner_pic ?>
	<tr id="r_kilowatt_homebanner_pic">
		<td><span id="elh_kilowatt_homebanners_kilowatt_homebanner_pic"><?php echo $kilowatt_homebanners->kilowatt_homebanner_pic->FldCaption() ?></span></td>
...
<span>
<?php echo ew_GetFileViewTag($kilowatt_homebanners->kilowatt_homebanner_pic, $kilowatt_homebanners->kilowatt_homebanner_pic->ViewValue) ?>
</span>
</span>
</td>
	</tr>
...
<?php if ($kilowatt_homebanners->kilowatt_homebanner_buttontext->Visible) { // kilowatt_homebanner_buttontext ?>
	<tr id="r_kilowatt_homebanner_buttontext">
		<td><span id="elh_kilowatt_homebanners_kilowatt_homebanner_buttontext"><?php echo $kilowatt_homebanners->kilowatt_homebanner_buttontext->FldCaption() ?></span></td>
...
<?php echo $kilowatt_homebanners->kilowatt_homebanner_buttontext->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($kilowatt_homebanners->kilowatt_homebanner_buttonlink->Visible) { // kilowatt_homebanner_buttonlink ?>
	<tr id="r_kilowatt_homebanner_buttonlink">
		<td><span id="elh_kilowatt_homebanners_kilowatt_homebanner_buttonlink"><?php echo $kilowatt_homebanners->kilowatt_homebanner_buttonlink->FldCaption() ?></span></td>
...
<?php echo $kilowatt_homebanners->kilowatt_homebanner_buttonlink->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($kilowatt_homebanners->sort_order->Visible) { // sort_order ?>
	<tr id="r_sort_order">
		<td><span id="elh_kilowatt_homebanners_sort_order"><?php echo $kilowatt_homebanners->sort_order->FldCaption() ?></span></td>
...
<?php echo $kilowatt_homebanners->sort_order->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($kilowatt_homebanners->status->Visible) { // status ?>
	<tr id="r_status">
		<td><span id="elh_kilowatt_homebanners_status"><?php echo $kilowatt_homebanners->status->FldCaption() ?></span></td>
...
<?php echo $kilowatt_homebanners->status->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<script type="text/javascript">
fkilowatt_homebannersview.Init();
</script>
<?php
$kilowatt_homebanners_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$kilowatt_homebanners_view->Page_Terminate();
?>
