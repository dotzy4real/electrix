...
class cservices_view extends cservices {
	...
	function __construct() {
		...
		$KeyUrl = "";
		if (@$_GET["service_id"] <> "") {
			$this->RecKey["service_id"] = $_GET["service_id"];
			$KeyUrl .= "&amp;service_id=" . urlencode($this->RecKey["service_id"]);
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["service_id"] <> "") {
				...
				$this->service_id->setFormValue($_POST["service_id"]);
...
fservicesview.Lists["x_service_icon"] = {"LinkField":"","Ajax":false,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fservicesview.Lists["x_service_icon"].Options = <?php echo json_encode($services->service_icon->Options()) ?>;
fservicesview.Lists["x_status"] = {"LinkField":"","Ajax":false,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fservicesview.Lists["x_status"].Options = <?php echo json_encode($services->status->Options()) ?>;
...
<?php if ($services->service_id->Visible) { // service_id ?>
	<tr id="r_service_id">
		<td><span id="elh_services_service_id"><?php echo $services->service_id->FldCaption() ?></span></td>
...
<?php echo $services->service_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($services->service_small_pic->Visible) { // service_small_pic ?>
	<tr id="r_service_small_pic">
		<td><span id="elh_services_service_small_pic"><?php echo $services->service_small_pic->FldCaption() ?></span></td>
		<td data-name="service_small_pic"<?php echo $services->service_small_pic->CellAttributes() ?>>
<span id="el_services_service_small_pic">
<span>
<?php echo ew_GetFileViewTag($services->service_small_pic, $services->service_small_pic->ViewValue) ?>
</span>
</span>
</td>
	</tr>
...
<?php if ($services->service_large_pic->Visible) { // service_large_pic ?>
	<tr id="r_service_large_pic">
		<td><span id="elh_services_service_large_pic"><?php echo $services->service_large_pic->FldCaption() ?></span></td>
		<td data-name="service_large_pic"<?php echo $services->service_large_pic->CellAttributes() ?>>
<span id="el_services_service_large_pic">
<span>
<?php echo ew_GetFileViewTag($services->service_large_pic, $services->service_large_pic->ViewValue) ?>
</span>
</span>
</td>
	</tr>
...
<?php if ($services->service_title->Visible) { // service_title ?>
	<tr id="r_service_title">
		<td><span id="elh_services_service_title"><?php echo $services->service_title->FldCaption() ?></span></td>
...
<?php echo $services->service_title->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($services->service_content->Visible) { // service_content ?>
	<tr id="r_service_content">
		<td><span id="elh_services_service_content"><?php echo $services->service_content->FldCaption() ?></span></td>
		<td data-name="service_content"<?php echo $services->service_content->CellAttributes() ?>>
<span id="el_services_service_content">
<span<?php echo $services->service_content->ViewAttributes() ?>>
<?php echo $services->service_content->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($services->service_icon->Visible) { // service_icon ?>
	<tr id="r_service_icon">
		<td><span id="elh_services_service_icon"><?php echo $services->service_icon->FldCaption() ?></span></td>
...
<?php echo $services->service_icon->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($services->sort_order->Visible) { // sort_order ?>
	<tr id="r_sort_order">
		<td><span id="elh_services_sort_order"><?php echo $services->sort_order->FldCaption() ?></span></td>
...
<?php echo $services->sort_order->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($services->status->Visible) { // status ?>
	<tr id="r_status">
		<td><span id="elh_services_status"><?php echo $services->status->FldCaption() ?></span></td>
...
<?php echo $services->status->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
