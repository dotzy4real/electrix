...
$skyview_about_view = NULL; // Initialize page object first

class cskyview_about_view extends cskyview_about {
	...
	// Page object name
	var $PageObjName = 'skyview_about_view';
	...
	function __construct() {
		...
		if (@$_GET["skyview_about_id"] <> "") {
			$this->RecKey["skyview_about_id"] = $_GET["skyview_about_id"];
			$KeyUrl .= "&amp;skyview_about_id=" . urlencode($this->RecKey["skyview_about_id"]);
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["skyview_about_id"] <> "") {
				...
				$this->RecKey["skyview_about_id"] = $this->skyview_about_id->QueryStringValue;
			} elseif (@$_POST["skyview_about_id"] <> "") {
				$this->skyview_about_id->setFormValue($_POST["skyview_about_id"]);
				$this->RecKey["skyview_about_id"] = $this->skyview_about_id->FormValue;
			} else {
				$sReturnUrl = "skyview_aboutlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "skyview_aboutlist.php"; // No matching record, return to list
					}
			}
		} else {
			$sReturnUrl = "skyview_aboutlist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($skyview_about_view)) $skyview_about_view = new cskyview_about_view();

// Page init
$skyview_about_view->Page_Init();

// Page main
$skyview_about_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$skyview_about_view->Page_Render();
?>
...
var CurrentForm = fskyview_aboutview = new ew_Form("fskyview_aboutview", "view");

// Form_CustomValidate event
fskyview_aboutview.Form_CustomValidate = 
...
fskyview_aboutview.ValidateRequired = true;
<?php } else { ?>
fskyview_aboutview.ValidateRequired = false; 
<?php } ?>
...
<?php $skyview_about_view->ExportOptions->Render("body") ?>
<?php
	foreach ($skyview_about_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php echo $Language->SelectionForm(); ?>
<div class="clearfix"></div>
</div>
<?php $skyview_about_view->ShowPageHeader(); ?>
<?php
$skyview_about_view->ShowMessage();
?>
<form name="fskyview_aboutview" id="fskyview_aboutview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($skyview_about_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $skyview_about_view->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="skyview_about">
<table class="table table-bordered table-striped ewViewTable">
<?php if ($skyview_about->skyview_about_id->Visible) { // skyview_about_id ?>
	<tr id="r_skyview_about_id">
		<td><span id="elh_skyview_about_skyview_about_id"><?php echo $skyview_about->skyview_about_id->FldCaption() ?></span></td>
...
<?php echo $skyview_about->skyview_about_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($skyview_about->skyview_about_left_pic->Visible) { // skyview_about_left_pic ?>
	<tr id="r_skyview_about_left_pic">
		<td><span id="elh_skyview_about_skyview_about_left_pic"><?php echo $skyview_about->skyview_about_left_pic->FldCaption() ?></span></td>
...
<span>
<?php echo ew_GetFileViewTag($skyview_about->skyview_about_left_pic, $skyview_about->skyview_about_left_pic->ViewValue) ?>
</span>
</span>
</td>
	</tr>
...
<?php if ($skyview_about->skyview_about_right_pic->Visible) { // skyview_about_right_pic ?>
	<tr id="r_skyview_about_right_pic">
		<td><span id="elh_skyview_about_skyview_about_right_pic"><?php echo $skyview_about->skyview_about_right_pic->FldCaption() ?></span></td>
...
<span>
<?php echo ew_GetFileViewTag($skyview_about->skyview_about_right_pic, $skyview_about->skyview_about_right_pic->ViewValue) ?>
</span>
</span>
</td>
	</tr>
...
<?php if ($skyview_about->skyview_about_goal->Visible) { // skyview_about_goal ?>
	<tr id="r_skyview_about_goal">
		<td><span id="elh_skyview_about_skyview_about_goal"><?php echo $skyview_about->skyview_about_goal->FldCaption() ?></span></td>
		<td data-name="skyview_about_goal"<?php echo $skyview_about->skyview_about_goal->CellAttributes() ?>>
<span id="el_skyview_about_skyview_about_goal">
<span<?php echo $skyview_about->skyview_about_goal->ViewAttributes() ?>>
<?php echo $skyview_about->skyview_about_goal->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($skyview_about->skyview_about_icon_title->Visible) { // skyview_about_icon_title ?>
	<tr id="r_skyview_about_icon_title">
		<td><span id="elh_skyview_about_skyview_about_icon_title"><?php echo $skyview_about->skyview_about_icon_title->FldCaption() ?></span></td>
...
<?php echo $skyview_about->skyview_about_icon_title->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($skyview_about->skyview_about_title->Visible) { // skyview_about_title ?>
	<tr id="r_skyview_about_title">
		<td><span id="elh_skyview_about_skyview_about_title"><?php echo $skyview_about->skyview_about_title->FldCaption() ?></span></td>
...
<?php echo $skyview_about->skyview_about_title->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($skyview_about->skyview_about_content->Visible) { // skyview_about_content ?>
	<tr id="r_skyview_about_content">
		<td><span id="elh_skyview_about_skyview_about_content"><?php echo $skyview_about->skyview_about_content->FldCaption() ?></span></td>
		<td data-name="skyview_about_content"<?php echo $skyview_about->skyview_about_content->CellAttributes() ?>>
<span id="el_skyview_about_skyview_about_content">
<span<?php echo $skyview_about->skyview_about_content->ViewAttributes() ?>>
<?php echo $skyview_about->skyview_about_content->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<script type="text/javascript">
fskyview_aboutview.Init();
</script>
<?php
$skyview_about_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$skyview_about_view->Page_Terminate();
?>
