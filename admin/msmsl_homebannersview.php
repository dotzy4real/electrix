...
$msmsl_homebanners_view = NULL; // Initialize page object first

class cmsmsl_homebanners_view extends cmsmsl_homebanners {
	...
	// Page object name
	var $PageObjName = 'msmsl_homebanners_view';
	...
	function __construct() {
		...
		if (@$_GET["msmsl_homebanner_id"] <> "") {
			$this->RecKey["msmsl_homebanner_id"] = $_GET["msmsl_homebanner_id"];
			$KeyUrl .= "&amp;msmsl_homebanner_id=" . urlencode($this->RecKey["msmsl_homebanner_id"]);
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["msmsl_homebanner_id"] <> "") {
				...
				$this->RecKey["msmsl_homebanner_id"] = $this->msmsl_homebanner_id->QueryStringValue;
			} elseif (@$_POST["msmsl_homebanner_id"] <> "") {
				$this->msmsl_homebanner_id->setFormValue($_POST["msmsl_homebanner_id"]);
				$this->RecKey["msmsl_homebanner_id"] = $this->msmsl_homebanner_id->FormValue;
			} else {
				$sReturnUrl = "msmsl_homebannerslist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "msmsl_homebannerslist.php"; // No matching record, return to list
					}
			}
		} else {
			$sReturnUrl = "msmsl_homebannerslist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($msmsl_homebanners_view)) $msmsl_homebanners_view = new cmsmsl_homebanners_view();

// Page init
$msmsl_homebanners_view->Page_Init();

// Page main
$msmsl_homebanners_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$msmsl_homebanners_view->Page_Render();
?>
...
var CurrentForm = fmsmsl_homebannersview = new ew_Form("fmsmsl_homebannersview", "view");

// Form_CustomValidate event
fmsmsl_homebannersview.Form_CustomValidate = 
...
fmsmsl_homebannersview.ValidateRequired = true;
<?php } else { ?>
fmsmsl_homebannersview.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fmsmsl_homebannersview.Lists["x_status"] = {"LinkField":"","Ajax":false,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fmsmsl_homebannersview.Lists["x_status"].Options = <?php echo json_encode($msmsl_homebanners->status->Options()) ?>;
...
<?php $msmsl_homebanners_view->ExportOptions->Render("body") ?>
<?php
	foreach ($msmsl_homebanners_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php echo $Language->SelectionForm(); ?>
<div class="clearfix"></div>
</div>
<?php $msmsl_homebanners_view->ShowPageHeader(); ?>
<?php
$msmsl_homebanners_view->ShowMessage();
?>
<form name="fmsmsl_homebannersview" id="fmsmsl_homebannersview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($msmsl_homebanners_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $msmsl_homebanners_view->Token ?>">
<?php } ?>
...
<?php if ($msmsl_homebanners->msmsl_homebanner_id->Visible) { // msmsl_homebanner_id ?>
	<tr id="r_msmsl_homebanner_id">
		<td><span id="elh_msmsl_homebanners_msmsl_homebanner_id"><?php echo $msmsl_homebanners->msmsl_homebanner_id->FldCaption() ?></span></td>
		<td data-name="msmsl_homebanner_id"<?php echo $msmsl_homebanners->msmsl_homebanner_id->CellAttributes() ?>>
<span id="el_msmsl_homebanners_msmsl_homebanner_id">
<span<?php echo $msmsl_homebanners->msmsl_homebanner_id->ViewAttributes() ?>>
<?php echo $msmsl_homebanners->msmsl_homebanner_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($msmsl_homebanners->msmsl_homebanner_top_title->Visible) { // msmsl_homebanner_top_title ?>
	<tr id="r_msmsl_homebanner_top_title">
		<td><span id="elh_msmsl_homebanners_msmsl_homebanner_top_title"><?php echo $msmsl_homebanners->msmsl_homebanner_top_title->FldCaption() ?></span></td>
...
<?php echo $msmsl_homebanners->msmsl_homebanner_top_title->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($msmsl_homebanners->msmsl_homebanner_main_title->Visible) { // msmsl_homebanner_main_title ?>
	<tr id="r_msmsl_homebanner_main_title">
		<td><span id="elh_msmsl_homebanners_msmsl_homebanner_main_title"><?php echo $msmsl_homebanners->msmsl_homebanner_main_title->FldCaption() ?></span></td>
...
<?php echo $msmsl_homebanners->msmsl_homebanner_main_title->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($msmsl_homebanners->msmsl_homebanner_low_title->Visible) { // msmsl_homebanner_low_title ?>
	<tr id="r_msmsl_homebanner_low_title">
		<td><span id="elh_msmsl_homebanners_msmsl_homebanner_low_title"><?php echo $msmsl_homebanners->msmsl_homebanner_low_title->FldCaption() ?></span></td>
...
<?php echo $msmsl_homebanners->msmsl_homebanner_low_title->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($msmsl_homebanners->msmsl_homebanner_pic->Visible) { // msmsl_homebanner_pic ?>
	<tr id="r_msmsl_homebanner_pic">
		<td><span id="elh_msmsl_homebanners_msmsl_homebanner_pic"><?php echo $msmsl_homebanners->msmsl_homebanner_pic->FldCaption() ?></span></td>
...
<span>
<?php echo ew_GetFileViewTag($msmsl_homebanners->msmsl_homebanner_pic, $msmsl_homebanners->msmsl_homebanner_pic->ViewValue) ?>
</span>
</span>
</td>
	</tr>
...
<?php if ($msmsl_homebanners->msmsl_homebanner_button_text->Visible) { // msmsl_homebanner_button_text ?>
	<tr id="r_msmsl_homebanner_button_text">
		<td><span id="elh_msmsl_homebanners_msmsl_homebanner_button_text"><?php echo $msmsl_homebanners->msmsl_homebanner_button_text->FldCaption() ?></span></td>
...
<?php echo $msmsl_homebanners->msmsl_homebanner_button_text->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($msmsl_homebanners->msmsl_homebanner_banner_link->Visible) { // msmsl_homebanner_banner_link ?>
	<tr id="r_msmsl_homebanner_banner_link">
		<td><span id="elh_msmsl_homebanners_msmsl_homebanner_banner_link"><?php echo $msmsl_homebanners->msmsl_homebanner_banner_link->FldCaption() ?></span></td>
...
<?php echo $msmsl_homebanners->msmsl_homebanner_banner_link->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($msmsl_homebanners->sort_order->Visible) { // sort_order ?>
	<tr id="r_sort_order">
		<td><span id="elh_msmsl_homebanners_sort_order"><?php echo $msmsl_homebanners->sort_order->FldCaption() ?></span></td>
...
<?php echo $msmsl_homebanners->sort_order->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($msmsl_homebanners->status->Visible) { // status ?>
	<tr id="r_status">
		<td><span id="elh_msmsl_homebanners_status"><?php echo $msmsl_homebanners->status->FldCaption() ?></span></td>
...
<?php echo $msmsl_homebanners->status->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<script type="text/javascript">
fmsmsl_homebannersview.Init();
</script>
<?php
$msmsl_homebanners_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$msmsl_homebanners_view->Page_Terminate();
?>
