...
define("EW_PROJECT_NAME", "electrix", TRUE); // Project name
define("EW_CONFIG_FILE_FOLDER", EW_PROJECT_NAME . "", TRUE); // Config file name
define("EW_PROJECT_ID", "{C922A933-D668-4910-9FB5-9885A2020F86}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'y32jrTWXb9QCTfvX', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/electrix.css", TRUE); // Project stylesheet file name
...
$EW_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "", "db" => "electrix", "qs" => "`", "qe" => "`");
...
define("EW_ADMIN_PASSWORD", "electrix!23", TRUE); // Administrator password
...
define("EW_UPLOAD_DEST_PATH", "../src/assets/images/", TRUE); // Upload destination path (relative to app root)
