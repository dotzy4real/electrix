	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["page_id"] <> "") {
				...
				$sReturnUrl = "pageslist.php"; // Return to list
			}
...
var CurrentForm = fpagesview = new ew_Form("fpagesview", "view");
...
fpagesview.Lists["x_page_show_title"] = {"LinkField":"","Ajax":false,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fpagesview.Lists["x_page_show_title"].Options = <?php echo json_encode($pages->page_show_title->Options()) ?>;
...
?>
<form name="fpagesview" id="fpagesview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($pages_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $pages_view->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="pages">
<table class="table table-bordered table-striped ewViewTable">
<?php if ($pages->page_id->Visible) { // page_id ?>
	<tr id="r_page_id">
		<td><span id="elh_pages_page_id"><?php echo $pages->page_id->FldCaption() ?></span></td>
...
<?php echo $pages->page_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($pages->page_name->Visible) { // page_name ?>
	<tr id="r_page_name">
		<td><span id="elh_pages_page_name"><?php echo $pages->page_name->FldCaption() ?></span></td>
...
<?php echo $pages->page_name->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($pages->page_icon_title->Visible) { // page_icon_title ?>
	<tr id="r_page_icon_title">
		<td><span id="elh_pages_page_icon_title"><?php echo $pages->page_icon_title->FldCaption() ?></span></td>
...
<?php echo $pages->page_icon_title->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($pages->page_title->Visible) { // page_title ?>
	<tr id="r_page_title">
		<td><span id="elh_pages_page_title"><?php echo $pages->page_title->FldCaption() ?></span></td>
...
<?php echo $pages->page_title->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($pages->page_breadcumb_title->Visible) { // page_breadcumb_title ?>
	<tr id="r_page_breadcumb_title">
		<td><span id="elh_pages_page_breadcumb_title"><?php echo $pages->page_breadcumb_title->FldCaption() ?></span></td>
...
<?php echo $pages->page_breadcumb_title->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($pages->page_content->Visible) { // page_content ?>
	<tr id="r_page_content">
		<td><span id="elh_pages_page_content"><?php echo $pages->page_content->FldCaption() ?></span></td>
		<td data-name="page_content"<?php echo $pages->page_content->CellAttributes() ?>>
<span id="el_pages_page_content">
<span<?php echo $pages->page_content->ViewAttributes() ?>>
<?php echo $pages->page_content->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($pages->page_banner->Visible) { // page_banner ?>
	<tr id="r_page_banner">
		<td><span id="elh_pages_page_banner"><?php echo $pages->page_banner->FldCaption() ?></span></td>
		<td data-name="page_banner"<?php echo $pages->page_banner->CellAttributes() ?>>
<span id="el_pages_page_banner">
<span>
<?php echo ew_GetFileViewTag($pages->page_banner, $pages->page_banner->ViewValue) ?>
</span>
</span>
</td>
	</tr>
...
<?php if ($pages->page_title_caption->Visible) { // page_title_caption ?>
	<tr id="r_page_title_caption">
		<td><span id="elh_pages_page_title_caption"><?php echo $pages->page_title_caption->FldCaption() ?></span></td>
...
<?php echo $pages->page_title_caption->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($pages->page_show_title->Visible) { // page_show_title ?>
	<tr id="r_page_show_title">
		<td><span id="elh_pages_page_show_title"><?php echo $pages->page_show_title->FldCaption() ?></span></td>
...
<?php echo $pages->page_show_title->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
