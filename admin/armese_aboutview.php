...
$armese_about_view = NULL; // Initialize page object first

class carmese_about_view extends carmese_about {
	...
	// Page object name
	var $PageObjName = 'armese_about_view';
	...
	function __construct() {
		...
		if (@$_GET["armese_about_id"] <> "") {
			$this->RecKey["armese_about_id"] = $_GET["armese_about_id"];
			$KeyUrl .= "&amp;armese_about_id=" . urlencode($this->RecKey["armese_about_id"]);
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["armese_about_id"] <> "") {
				...
				$this->RecKey["armese_about_id"] = $this->armese_about_id->QueryStringValue;
			} elseif (@$_POST["armese_about_id"] <> "") {
				$this->armese_about_id->setFormValue($_POST["armese_about_id"]);
				$this->RecKey["armese_about_id"] = $this->armese_about_id->FormValue;
			} else {
				$sReturnUrl = "armese_aboutlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "armese_aboutlist.php"; // No matching record, return to list
					}
			}
		} else {
			$sReturnUrl = "armese_aboutlist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($armese_about_view)) $armese_about_view = new carmese_about_view();

// Page init
$armese_about_view->Page_Init();

// Page main
$armese_about_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$armese_about_view->Page_Render();
?>
...
var CurrentForm = farmese_aboutview = new ew_Form("farmese_aboutview", "view");

// Form_CustomValidate event
farmese_aboutview.Form_CustomValidate = 
...
farmese_aboutview.ValidateRequired = true;
<?php } else { ?>
farmese_aboutview.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
farmese_aboutview.Lists["x_status"] = {"LinkField":"","Ajax":false,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
farmese_aboutview.Lists["x_status"].Options = <?php echo json_encode($armese_about->status->Options()) ?>;
...
<?php $armese_about_view->ExportOptions->Render("body") ?>
<?php
	foreach ($armese_about_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php echo $Language->SelectionForm(); ?>
<div class="clearfix"></div>
</div>
<?php $armese_about_view->ShowPageHeader(); ?>
<?php
$armese_about_view->ShowMessage();
?>
<form name="farmese_aboutview" id="farmese_aboutview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($armese_about_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $armese_about_view->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="armese_about">
<table class="table table-bordered table-striped ewViewTable">
<?php if ($armese_about->armese_about_id->Visible) { // armese_about_id ?>
	<tr id="r_armese_about_id">
		<td><span id="elh_armese_about_armese_about_id"><?php echo $armese_about->armese_about_id->FldCaption() ?></span></td>
...
<?php echo $armese_about->armese_about_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($armese_about->armese_about_title_icon->Visible) { // armese_about_title_icon ?>
	<tr id="r_armese_about_title_icon">
		<td><span id="elh_armese_about_armese_about_title_icon"><?php echo $armese_about->armese_about_title_icon->FldCaption() ?></span></td>
...
<?php echo $armese_about->armese_about_title_icon->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($armese_about->armese_about_title->Visible) { // armese_about_title ?>
	<tr id="r_armese_about_title">
		<td><span id="elh_armese_about_armese_about_title"><?php echo $armese_about->armese_about_title->FldCaption() ?></span></td>
...
<?php echo $armese_about->armese_about_title->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($armese_about->armese_about_left_pic->Visible) { // armese_about_left_pic ?>
	<tr id="r_armese_about_left_pic">
		<td><span id="elh_armese_about_armese_about_left_pic"><?php echo $armese_about->armese_about_left_pic->FldCaption() ?></span></td>
...
<span>
<?php echo ew_GetFileViewTag($armese_about->armese_about_left_pic, $armese_about->armese_about_left_pic->ViewValue) ?>
</span>
</span>
</td>
	</tr>
...
<?php if ($armese_about->armese_about_right_pic->Visible) { // armese_about_right_pic ?>
	<tr id="r_armese_about_right_pic">
		<td><span id="elh_armese_about_armese_about_right_pic"><?php echo $armese_about->armese_about_right_pic->FldCaption() ?></span></td>
...
<span>
<?php echo ew_GetFileViewTag($armese_about->armese_about_right_pic, $armese_about->armese_about_right_pic->ViewValue) ?>
</span>
</span>
</td>
	</tr>
...
<?php if ($armese_about->armese_about_home_content->Visible) { // armese_about_home_content ?>
	<tr id="r_armese_about_home_content">
		<td><span id="elh_armese_about_armese_about_home_content"><?php echo $armese_about->armese_about_home_content->FldCaption() ?></span></td>
		<td data-name="armese_about_home_content"<?php echo $armese_about->armese_about_home_content->CellAttributes() ?>>
<span id="el_armese_about_armese_about_home_content">
<span<?php echo $armese_about->armese_about_home_content->ViewAttributes() ?>>
<?php echo $armese_about->armese_about_home_content->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($armese_about->armese_about_full_content->Visible) { // armese_about_full_content ?>
	<tr id="r_armese_about_full_content">
		<td><span id="elh_armese_about_armese_about_full_content"><?php echo $armese_about->armese_about_full_content->FldCaption() ?></span></td>
		<td data-name="armese_about_full_content"<?php echo $armese_about->armese_about_full_content->CellAttributes() ?>>
<span id="el_armese_about_armese_about_full_content">
<span<?php echo $armese_about->armese_about_full_content->ViewAttributes() ?>>
<?php echo $armese_about->armese_about_full_content->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($armese_about->armese_about_management_team_id->Visible) { // armese_about_management_team_id ?>
	<tr id="r_armese_about_management_team_id">
		<td><span id="elh_armese_about_armese_about_management_team_id"><?php echo $armese_about->armese_about_management_team_id->FldCaption() ?></span></td>
...
<?php echo $armese_about->armese_about_management_team_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($armese_about->status->Visible) { // status ?>
	<tr id="r_status">
		<td><span id="elh_armese_about_status"><?php echo $armese_about->status->FldCaption() ?></span></td>
...
<?php echo $armese_about->status->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<script type="text/javascript">
farmese_aboutview.Init();
</script>
<?php
$armese_about_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$armese_about_view->Page_Terminate();
?>
