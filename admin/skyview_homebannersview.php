...
$skyview_homebanners_view = NULL; // Initialize page object first

class cskyview_homebanners_view extends cskyview_homebanners {
	...
	// Page object name
	var $PageObjName = 'skyview_homebanners_view';
	...
	function __construct() {
		...
		if (@$_GET["skyview_homebanner_id"] <> "") {
			$this->RecKey["skyview_homebanner_id"] = $_GET["skyview_homebanner_id"];
			$KeyUrl .= "&amp;skyview_homebanner_id=" . urlencode($this->RecKey["skyview_homebanner_id"]);
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["skyview_homebanner_id"] <> "") {
				...
				$this->RecKey["skyview_homebanner_id"] = $this->skyview_homebanner_id->QueryStringValue;
			} elseif (@$_POST["skyview_homebanner_id"] <> "") {
				$this->skyview_homebanner_id->setFormValue($_POST["skyview_homebanner_id"]);
				$this->RecKey["skyview_homebanner_id"] = $this->skyview_homebanner_id->FormValue;
			} else {
				$sReturnUrl = "skyview_homebannerslist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "skyview_homebannerslist.php"; // No matching record, return to list
					}
			}
		} else {
			$sReturnUrl = "skyview_homebannerslist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($skyview_homebanners_view)) $skyview_homebanners_view = new cskyview_homebanners_view();

// Page init
$skyview_homebanners_view->Page_Init();

// Page main
$skyview_homebanners_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$skyview_homebanners_view->Page_Render();
?>
...
var CurrentForm = fskyview_homebannersview = new ew_Form("fskyview_homebannersview", "view");

// Form_CustomValidate event
fskyview_homebannersview.Form_CustomValidate = 
...
fskyview_homebannersview.ValidateRequired = true;
<?php } else { ?>
fskyview_homebannersview.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fskyview_homebannersview.Lists["x_status"] = {"LinkField":"","Ajax":false,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fskyview_homebannersview.Lists["x_status"].Options = <?php echo json_encode($skyview_homebanners->status->Options()) ?>;
...
<?php $skyview_homebanners_view->ExportOptions->Render("body") ?>
<?php
	foreach ($skyview_homebanners_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php echo $Language->SelectionForm(); ?>
<div class="clearfix"></div>
</div>
<?php $skyview_homebanners_view->ShowPageHeader(); ?>
<?php
$skyview_homebanners_view->ShowMessage();
?>
<form name="fskyview_homebannersview" id="fskyview_homebannersview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($skyview_homebanners_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $skyview_homebanners_view->Token ?>">
<?php } ?>
...
<?php if ($skyview_homebanners->skyview_homebanner_id->Visible) { // skyview_homebanner_id ?>
	<tr id="r_skyview_homebanner_id">
		<td><span id="elh_skyview_homebanners_skyview_homebanner_id"><?php echo $skyview_homebanners->skyview_homebanner_id->FldCaption() ?></span></td>
...
<?php echo $skyview_homebanners->skyview_homebanner_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($skyview_homebanners->skyview_homebanner_top_title->Visible) { // skyview_homebanner_top_title ?>
	<tr id="r_skyview_homebanner_top_title">
		<td><span id="elh_skyview_homebanners_skyview_homebanner_top_title"><?php echo $skyview_homebanners->skyview_homebanner_top_title->FldCaption() ?></span></td>
...
<?php echo $skyview_homebanners->skyview_homebanner_top_title->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($skyview_homebanners->skyview_homebanner_main_title->Visible) { // skyview_homebanner_main_title ?>
	<tr id="r_skyview_homebanner_main_title">
		<td><span id="elh_skyview_homebanners_skyview_homebanner_main_title"><?php echo $skyview_homebanners->skyview_homebanner_main_title->FldCaption() ?></span></td>
...
<?php echo $skyview_homebanners->skyview_homebanner_main_title->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($skyview_homebanners->skyview_homebanner_pic->Visible) { // skyview_homebanner_pic ?>
	<tr id="r_skyview_homebanner_pic">
		<td><span id="elh_skyview_homebanners_skyview_homebanner_pic"><?php echo $skyview_homebanners->skyview_homebanner_pic->FldCaption() ?></span></td>
...
<span>
<?php echo ew_GetFileViewTag($skyview_homebanners->skyview_homebanner_pic, $skyview_homebanners->skyview_homebanner_pic->ViewValue) ?>
</span>
</span>
</td>
	</tr>
...
<?php if ($skyview_homebanners->skyview_homebanner_button_text->Visible) { // skyview_homebanner_button_text ?>
	<tr id="r_skyview_homebanner_button_text">
		<td><span id="elh_skyview_homebanners_skyview_homebanner_button_text"><?php echo $skyview_homebanners->skyview_homebanner_button_text->FldCaption() ?></span></td>
...
<?php echo $skyview_homebanners->skyview_homebanner_button_text->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($skyview_homebanners->skyview_homebanner_button_link->Visible) { // skyview_homebanner_button_link ?>
	<tr id="r_skyview_homebanner_button_link">
		<td><span id="elh_skyview_homebanners_skyview_homebanner_button_link"><?php echo $skyview_homebanners->skyview_homebanner_button_link->FldCaption() ?></span></td>
...
<?php echo $skyview_homebanners->skyview_homebanner_button_link->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($skyview_homebanners->sort_order->Visible) { // sort_order ?>
	<tr id="r_sort_order">
		<td><span id="elh_skyview_homebanners_sort_order"><?php echo $skyview_homebanners->sort_order->FldCaption() ?></span></td>
...
<?php echo $skyview_homebanners->sort_order->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($skyview_homebanners->status->Visible) { // status ?>
	<tr id="r_status">
		<td><span id="elh_skyview_homebanners_status"><?php echo $skyview_homebanners->status->FldCaption() ?></span></td>
...
<?php echo $skyview_homebanners->status->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<script type="text/javascript">
fskyview_homebannersview.Init();
</script>
<?php
$skyview_homebanners_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$skyview_homebanners_view->Page_Terminate();
?>
