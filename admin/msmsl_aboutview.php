...
$msmsl_about_view = NULL; // Initialize page object first

class cmsmsl_about_view extends cmsmsl_about {
	...
	// Page object name
	var $PageObjName = 'msmsl_about_view';
	...
	function __construct() {
		...
		if (@$_GET["msmsl_about_id"] <> "") {
			$this->RecKey["msmsl_about_id"] = $_GET["msmsl_about_id"];
			$KeyUrl .= "&amp;msmsl_about_id=" . urlencode($this->RecKey["msmsl_about_id"]);
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["msmsl_about_id"] <> "") {
				...
				$this->RecKey["msmsl_about_id"] = $this->msmsl_about_id->QueryStringValue;
			} elseif (@$_POST["msmsl_about_id"] <> "") {
				$this->msmsl_about_id->setFormValue($_POST["msmsl_about_id"]);
				$this->RecKey["msmsl_about_id"] = $this->msmsl_about_id->FormValue;
			} else {
				$sReturnUrl = "msmsl_aboutlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "msmsl_aboutlist.php"; // No matching record, return to list
					}
			}
		} else {
			$sReturnUrl = "msmsl_aboutlist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($msmsl_about_view)) $msmsl_about_view = new cmsmsl_about_view();

// Page init
$msmsl_about_view->Page_Init();

// Page main
$msmsl_about_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$msmsl_about_view->Page_Render();
?>
...
var CurrentForm = fmsmsl_aboutview = new ew_Form("fmsmsl_aboutview", "view");

// Form_CustomValidate event
fmsmsl_aboutview.Form_CustomValidate = 
...
fmsmsl_aboutview.ValidateRequired = true;
<?php } else { ?>
fmsmsl_aboutview.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fmsmsl_aboutview.Lists["x_msmsl_about_management_team_id"] = {"LinkField":"x_msmsl_management_team_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_msmsl_management_team_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
...
<?php $msmsl_about_view->ExportOptions->Render("body") ?>
<?php
	foreach ($msmsl_about_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php echo $Language->SelectionForm(); ?>
<div class="clearfix"></div>
</div>
<?php $msmsl_about_view->ShowPageHeader(); ?>
<?php
$msmsl_about_view->ShowMessage();
?>
<form name="fmsmsl_aboutview" id="fmsmsl_aboutview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($msmsl_about_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $msmsl_about_view->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="msmsl_about">
<table class="table table-bordered table-striped ewViewTable">
<?php if ($msmsl_about->msmsl_about_id->Visible) { // msmsl_about_id ?>
	<tr id="r_msmsl_about_id">
		<td><span id="elh_msmsl_about_msmsl_about_id"><?php echo $msmsl_about->msmsl_about_id->FldCaption() ?></span></td>
...
<?php echo $msmsl_about->msmsl_about_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($msmsl_about->msmsl_about_left_pic->Visible) { // msmsl_about_left_pic ?>
	<tr id="r_msmsl_about_left_pic">
		<td><span id="elh_msmsl_about_msmsl_about_left_pic"><?php echo $msmsl_about->msmsl_about_left_pic->FldCaption() ?></span></td>
...
<span>
<?php echo ew_GetFileViewTag($msmsl_about->msmsl_about_left_pic, $msmsl_about->msmsl_about_left_pic->ViewValue) ?>
</span>
</span>
</td>
	</tr>
...
<?php if ($msmsl_about->msmsl_about_right_pic->Visible) { // msmsl_about_right_pic ?>
	<tr id="r_msmsl_about_right_pic">
		<td><span id="elh_msmsl_about_msmsl_about_right_pic"><?php echo $msmsl_about->msmsl_about_right_pic->FldCaption() ?></span></td>
...
<span>
<?php echo ew_GetFileViewTag($msmsl_about->msmsl_about_right_pic, $msmsl_about->msmsl_about_right_pic->ViewValue) ?>
</span>
</span>
</td>
	</tr>
...
<?php if ($msmsl_about->msmsl_about_experience_years->Visible) { // msmsl_about_experience_years ?>
	<tr id="r_msmsl_about_experience_years">
		<td><span id="elh_msmsl_about_msmsl_about_experience_years"><?php echo $msmsl_about->msmsl_about_experience_years->FldCaption() ?></span></td>
...
<?php echo $msmsl_about->msmsl_about_experience_years->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($msmsl_about->msmsl_about_icon_title->Visible) { // msmsl_about_icon_title ?>
	<tr id="r_msmsl_about_icon_title">
		<td><span id="elh_msmsl_about_msmsl_about_icon_title"><?php echo $msmsl_about->msmsl_about_icon_title->FldCaption() ?></span></td>
...
<?php echo $msmsl_about->msmsl_about_icon_title->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($msmsl_about->msmsl_about_title->Visible) { // msmsl_about_title ?>
	<tr id="r_msmsl_about_title">
		<td><span id="elh_msmsl_about_msmsl_about_title"><?php echo $msmsl_about->msmsl_about_title->FldCaption() ?></span></td>
...
<?php echo $msmsl_about->msmsl_about_title->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($msmsl_about->msmsl_about_content->Visible) { // msmsl_about_content ?>
	<tr id="r_msmsl_about_content">
		<td><span id="elh_msmsl_about_msmsl_about_content"><?php echo $msmsl_about->msmsl_about_content->FldCaption() ?></span></td>
		<td data-name="msmsl_about_content"<?php echo $msmsl_about->msmsl_about_content->CellAttributes() ?>>
<span id="el_msmsl_about_msmsl_about_content">
<span<?php echo $msmsl_about->msmsl_about_content->ViewAttributes() ?>>
<?php echo $msmsl_about->msmsl_about_content->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($msmsl_about->msmsl_about_management_team_id->Visible) { // msmsl_about_management_team_id ?>
	<tr id="r_msmsl_about_management_team_id">
		<td><span id="elh_msmsl_about_msmsl_about_management_team_id"><?php echo $msmsl_about->msmsl_about_management_team_id->FldCaption() ?></span></td>
...
<?php echo $msmsl_about->msmsl_about_management_team_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<script type="text/javascript">
fmsmsl_aboutview.Init();
</script>
<?php
$msmsl_about_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$msmsl_about_view->Page_Terminate();
?>
