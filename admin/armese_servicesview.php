...
$armese_services_view = NULL; // Initialize page object first

class carmese_services_view extends carmese_services {
	...
	// Page object name
	var $PageObjName = 'armese_services_view';
	...
	function __construct() {
		...
		if (@$_GET["armese_service_id"] <> "") {
			$this->RecKey["armese_service_id"] = $_GET["armese_service_id"];
			$KeyUrl .= "&amp;armese_service_id=" . urlencode($this->RecKey["armese_service_id"]);
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["armese_service_id"] <> "") {
				...
				$this->RecKey["armese_service_id"] = $this->armese_service_id->QueryStringValue;
			} elseif (@$_POST["armese_service_id"] <> "") {
				$this->armese_service_id->setFormValue($_POST["armese_service_id"]);
				$this->RecKey["armese_service_id"] = $this->armese_service_id->FormValue;
			} else {
				$sReturnUrl = "armese_serviceslist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "armese_serviceslist.php"; // No matching record, return to list
					}
			}
		} else {
			$sReturnUrl = "armese_serviceslist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($armese_services_view)) $armese_services_view = new carmese_services_view();

// Page init
$armese_services_view->Page_Init();

// Page main
$armese_services_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$armese_services_view->Page_Render();
?>
...
var CurrentForm = farmese_servicesview = new ew_Form("farmese_servicesview", "view");

// Form_CustomValidate event
farmese_servicesview.Form_CustomValidate = 
...
farmese_servicesview.ValidateRequired = true;
<?php } else { ?>
farmese_servicesview.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
farmese_servicesview.Lists["x_armese_service_icon"] = {"LinkField":"","Ajax":false,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
farmese_servicesview.Lists["x_armese_service_icon"].Options = <?php echo json_encode($armese_services->armese_service_icon->Options()) ?>;
farmese_servicesview.Lists["x_status"] = {"LinkField":"","Ajax":false,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
farmese_servicesview.Lists["x_status"].Options = <?php echo json_encode($armese_services->status->Options()) ?>;
...
<?php $armese_services_view->ExportOptions->Render("body") ?>
<?php
	foreach ($armese_services_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php echo $Language->SelectionForm(); ?>
<div class="clearfix"></div>
</div>
<?php $armese_services_view->ShowPageHeader(); ?>
<?php
$armese_services_view->ShowMessage();
?>
<form name="farmese_servicesview" id="farmese_servicesview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($armese_services_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $armese_services_view->Token ?>">
<?php } ?>
...
<?php if ($armese_services->armese_service_id->Visible) { // armese_service_id ?>
	<tr id="r_armese_service_id">
		<td><span id="elh_armese_services_armese_service_id"><?php echo $armese_services->armese_service_id->FldCaption() ?></span></td>
...
<?php echo $armese_services->armese_service_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($armese_services->armese_service_title->Visible) { // armese_service_title ?>
	<tr id="r_armese_service_title">
		<td><span id="elh_armese_services_armese_service_title"><?php echo $armese_services->armese_service_title->FldCaption() ?></span></td>
...
<?php echo $armese_services->armese_service_title->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($armese_services->armese_service_snippet->Visible) { // armese_service_snippet ?>
	<tr id="r_armese_service_snippet">
		<td><span id="elh_armese_services_armese_service_snippet"><?php echo $armese_services->armese_service_snippet->FldCaption() ?></span></td>
		<td data-name="armese_service_snippet"<?php echo $armese_services->armese_service_snippet->CellAttributes() ?>>
<span id="el_armese_services_armese_service_snippet">
<span<?php echo $armese_services->armese_service_snippet->ViewAttributes() ?>>
<?php echo $armese_services->armese_service_snippet->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($armese_services->armese_service_pic->Visible) { // armese_service_pic ?>
	<tr id="r_armese_service_pic">
		<td><span id="elh_armese_services_armese_service_pic"><?php echo $armese_services->armese_service_pic->FldCaption() ?></span></td>
...
<span>
<?php echo ew_GetFileViewTag($armese_services->armese_service_pic, $armese_services->armese_service_pic->ViewValue) ?>
</span>
</span>
</td>
	</tr>
...
<?php if ($armese_services->armese_service_icon->Visible) { // armese_service_icon ?>
	<tr id="r_armese_service_icon">
		<td><span id="elh_armese_services_armese_service_icon"><?php echo $armese_services->armese_service_icon->FldCaption() ?></span></td>
...
<?php echo $armese_services->armese_service_icon->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($armese_services->sort_order->Visible) { // sort_order ?>
	<tr id="r_sort_order">
		<td><span id="elh_armese_services_sort_order"><?php echo $armese_services->sort_order->FldCaption() ?></span></td>
...
<?php echo $armese_services->sort_order->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($armese_services->status->Visible) { // status ?>
	<tr id="r_status">
		<td><span id="elh_armese_services_status"><?php echo $armese_services->status->FldCaption() ?></span></td>
...
<?php echo $armese_services->status->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<script type="text/javascript">
farmese_servicesview.Init();
</script>
<?php
$armese_services_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$armese_services_view->Page_Terminate();
?>
