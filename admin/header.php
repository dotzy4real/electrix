...
<div class="ewLayout">
	...
	<div id="ewHeaderRow" style="background: #000; padding:10px 20px; border-bottom:1px solid #EC3237" class="<?php echo $gsHeaderRowClass ?>"><img width="80" src="../src/assets/images/logo1.png" alt=""></div>
<?php if (ew_IsResponsiveLayout()) { ?>
