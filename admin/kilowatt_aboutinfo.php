...
//
// Table class for kilowatt_about
//
class ckilowatt_about extends cTable {
	var $kilowatt_about_id;
	var $kilowatt_about_left_pic;
	var $kilowatt_about_right_pic;
	var $kilowatt_about_experience_years;
	var $kilowatt_about_icon_title;
	var $kilowatt_about_title;
	var $kilowatt_about_snippet;
	var $kilowatt_about_full_content;
	...
	function __construct() {
		...
		$this->TableVar = 'kilowatt_about';
		$this->TableName = 'kilowatt_about';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`kilowatt_about`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// kilowatt_about_id
		$this->kilowatt_about_id = new cField('kilowatt_about', 'kilowatt_about', 'x_kilowatt_about_id', 'kilowatt_about_id', '`kilowatt_about_id`', '`kilowatt_about_id`', 19, -1, FALSE, '`kilowatt_about_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->kilowatt_about_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['kilowatt_about_id'] = &$this->kilowatt_about_id;

		// kilowatt_about_left_pic
		$this->kilowatt_about_left_pic = new cField('kilowatt_about', 'kilowatt_about', 'x_kilowatt_about_left_pic', 'kilowatt_about_left_pic', '`kilowatt_about_left_pic`', '`kilowatt_about_left_pic`', 200, -1, TRUE, '`kilowatt_about_left_pic`', FALSE, FALSE, FALSE, 'IMAGE', 'FILE');
		$this->fields['kilowatt_about_left_pic'] = &$this->kilowatt_about_left_pic;

		// kilowatt_about_right_pic
		$this->kilowatt_about_right_pic = new cField('kilowatt_about', 'kilowatt_about', 'x_kilowatt_about_right_pic', 'kilowatt_about_right_pic', '`kilowatt_about_right_pic`', '`kilowatt_about_right_pic`', 200, -1, TRUE, '`kilowatt_about_right_pic`', FALSE, FALSE, FALSE, 'IMAGE', 'FILE');
		$this->fields['kilowatt_about_right_pic'] = &$this->kilowatt_about_right_pic;

		// kilowatt_about_experience_years
		$this->kilowatt_about_experience_years = new cField('kilowatt_about', 'kilowatt_about', 'x_kilowatt_about_experience_years', 'kilowatt_about_experience_years', '`kilowatt_about_experience_years`', '`kilowatt_about_experience_years`', 3, -1, FALSE, '`kilowatt_about_experience_years`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->kilowatt_about_experience_years->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['kilowatt_about_experience_years'] = &$this->kilowatt_about_experience_years;

		// kilowatt_about_icon_title
		$this->kilowatt_about_icon_title = new cField('kilowatt_about', 'kilowatt_about', 'x_kilowatt_about_icon_title', 'kilowatt_about_icon_title', '`kilowatt_about_icon_title`', '`kilowatt_about_icon_title`', 200, -1, FALSE, '`kilowatt_about_icon_title`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->fields['kilowatt_about_icon_title'] = &$this->kilowatt_about_icon_title;

		// kilowatt_about_title
		$this->kilowatt_about_title = new cField('kilowatt_about', 'kilowatt_about', 'x_kilowatt_about_title', 'kilowatt_about_title', '`kilowatt_about_title`', '`kilowatt_about_title`', 200, -1, FALSE, '`kilowatt_about_title`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->fields['kilowatt_about_title'] = &$this->kilowatt_about_title;

		// kilowatt_about_snippet
		$this->kilowatt_about_snippet = new cField('kilowatt_about', 'kilowatt_about', 'x_kilowatt_about_snippet', 'kilowatt_about_snippet', '`kilowatt_about_snippet`', '`kilowatt_about_snippet`', 201, -1, FALSE, '`kilowatt_about_snippet`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->fields['kilowatt_about_snippet'] = &$this->kilowatt_about_snippet;

		// kilowatt_about_full_content
		$this->kilowatt_about_full_content = new cField('kilowatt_about', 'kilowatt_about', 'x_kilowatt_about_full_content', 'kilowatt_about_full_content', '`kilowatt_about_full_content`', '`kilowatt_about_full_content`', 201, -1, FALSE, '`kilowatt_about_full_content`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->fields['kilowatt_about_full_content'] = &$this->kilowatt_about_full_content;
	}
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`kilowatt_about`";
	}
	...
	function DeleteSQL(&$rs, $where = "", $curfilter = TRUE) {
		...
		if (is_array($where))
			$where = $this->ArrayToFilter($where);
		if ($rs) {
			if (array_key_exists('kilowatt_about_id', $rs))
				ew_AddFilter($where, ew_QuotedName('kilowatt_about_id', $this->DBID) . '=' . ew_QuotedValue($rs['kilowatt_about_id'], $this->kilowatt_about_id->FldDataType, $this->DBID));
		}
		$filter = ($curfilter) ? $this->CurrentFilter : "";
		ew_AddFilter($filter, $where);
		if ($filter <> "")
	...
	function SqlKeyFilter() {
		return "`kilowatt_about_id` = @kilowatt_about_id@";
	}

	// Key filter
	function KeyFilter() {
		$sKeyFilter = $this->SqlKeyFilter();
		if (!is_numeric($this->kilowatt_about_id->CurrentValue))
			$sKeyFilter = "0=1"; // Invalid key
		$sKeyFilter = str_replace("@kilowatt_about_id@", ew_AdjustSql($this->kilowatt_about_id->CurrentValue, $this->DBID), $sKeyFilter); // Replace key value
		return $sKeyFilter;
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("kilowatt_aboutview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("kilowatt_aboutview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "kilowatt_aboutadd.php?" . $this->UrlParm($parm);
		else
			$url = "kilowatt_aboutadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("kilowatt_aboutedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("kilowatt_aboutadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("kilowatt_aboutdelete.php", $this->UrlParm());
	}
	...
	function KeyToJson() {
		$json = "";
		$json .= "kilowatt_about_id:" . ew_VarToJson($this->kilowatt_about_id->CurrentValue, "number", "'");
		return "{" . $json . "}";
	}
	...
	function KeyUrl($url, $parm = "") {
		$sUrl = $url . "?";
		if ($parm <> "") $sUrl .= $parm . "&";
		if (!is_null($this->kilowatt_about_id->CurrentValue)) {
			$sUrl .= "kilowatt_about_id=" . urlencode($this->kilowatt_about_id->CurrentValue);
		} else {
	...
	function GetRecordKeys() {
		...
		if (isset($_POST["key_m"])) {
			...
			$arKeys[] = $isPost ? ew_StripSlashes(@$_POST["kilowatt_about_id"]) : ew_StripSlashes(@$_GET["kilowatt_about_id"]); // kilowatt_about_id
	...
	function GetKeyFilter() {
		...
		foreach ($arKeys as $key) {
			...
			$this->kilowatt_about_id->CurrentValue = $key;
   ...
   // Common render codes
	...
	function RenderEditRow() {
		...
		$this->kilowatt_about_experience_years->EditValue = $this->kilowatt_about_experience_years->CurrentValue;
		...
		$this->kilowatt_about_icon_title->EditValue = $this->kilowatt_about_icon_title->CurrentValue;
		...
		$this->kilowatt_about_title->EditValue = $this->kilowatt_about_title->CurrentValue;
		...
		$this->kilowatt_about_snippet->EditValue = $this->kilowatt_about_snippet->CurrentValue;
		...
		$this->kilowatt_about_full_content->EditValue = $this->kilowatt_about_full_content->CurrentValue;
		...
		if (!$Doc->ExportCustom) {
			...
			if ($Doc->Horizontal) { // Horizontal format, write header
				...
				if ($ExportPageType == "view") {
					if ($this->kilowatt_about_id->Exportable) $Doc->ExportCaption($this->kilowatt_about_id);
					if ($this->kilowatt_about_left_pic->Exportable) $Doc->ExportCaption($this->kilowatt_about_left_pic);
					if ($this->kilowatt_about_right_pic->Exportable) $Doc->ExportCaption($this->kilowatt_about_right_pic);
					if ($this->kilowatt_about_experience_years->Exportable) $Doc->ExportCaption($this->kilowatt_about_experience_years);
					if ($this->kilowatt_about_icon_title->Exportable) $Doc->ExportCaption($this->kilowatt_about_icon_title);
					if ($this->kilowatt_about_title->Exportable) $Doc->ExportCaption($this->kilowatt_about_title);
					if ($this->kilowatt_about_snippet->Exportable) $Doc->ExportCaption($this->kilowatt_about_snippet);
					if ($this->kilowatt_about_full_content->Exportable) $Doc->ExportCaption($this->kilowatt_about_full_content);
				} else {
					if ($this->kilowatt_about_id->Exportable) $Doc->ExportCaption($this->kilowatt_about_id);
					if ($this->kilowatt_about_left_pic->Exportable) $Doc->ExportCaption($this->kilowatt_about_left_pic);
					if ($this->kilowatt_about_right_pic->Exportable) $Doc->ExportCaption($this->kilowatt_about_right_pic);
		...
		while (!$Recordset->EOF && $RecCnt < $StopRec) {
			...
			if (intval($RecCnt) >= intval($StartRec)) {
				...
				if (!$Doc->ExportCustom) {
					...
					if ($ExportPageType == "view") {
						if ($this->kilowatt_about_id->Exportable) $Doc->ExportField($this->kilowatt_about_id);
						if ($this->kilowatt_about_left_pic->Exportable) $Doc->ExportField($this->kilowatt_about_left_pic);
						if ($this->kilowatt_about_right_pic->Exportable) $Doc->ExportField($this->kilowatt_about_right_pic);
						if ($this->kilowatt_about_experience_years->Exportable) $Doc->ExportField($this->kilowatt_about_experience_years);
						if ($this->kilowatt_about_icon_title->Exportable) $Doc->ExportField($this->kilowatt_about_icon_title);
						if ($this->kilowatt_about_title->Exportable) $Doc->ExportField($this->kilowatt_about_title);
						if ($this->kilowatt_about_snippet->Exportable) $Doc->ExportField($this->kilowatt_about_snippet);
						if ($this->kilowatt_about_full_content->Exportable) $Doc->ExportField($this->kilowatt_about_full_content);
					} else {
						if ($this->kilowatt_about_id->Exportable) $Doc->ExportField($this->kilowatt_about_id);
						if ($this->kilowatt_about_left_pic->Exportable) $Doc->ExportField($this->kilowatt_about_left_pic);
						if ($this->kilowatt_about_right_pic->Exportable) $Doc->ExportField($this->kilowatt_about_right_pic);
