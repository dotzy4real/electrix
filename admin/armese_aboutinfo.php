...
//
// Table class for armese_about
//
class carmese_about extends cTable {
	var $armese_about_id;
	var $armese_about_title_icon;
	var $armese_about_title;
	var $armese_about_left_pic;
	var $armese_about_right_pic;
	var $armese_about_home_content;
	var $armese_about_full_content;
	var $armese_about_management_team_id;
	var $status;
	...
	function __construct() {
		...
		$this->TableVar = 'armese_about';
		$this->TableName = 'armese_about';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`armese_about`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// armese_about_id
		$this->armese_about_id = new cField('armese_about', 'armese_about', 'x_armese_about_id', 'armese_about_id', '`armese_about_id`', '`armese_about_id`', 19, -1, FALSE, '`armese_about_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->armese_about_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['armese_about_id'] = &$this->armese_about_id;

		// armese_about_title_icon
		$this->armese_about_title_icon = new cField('armese_about', 'armese_about', 'x_armese_about_title_icon', 'armese_about_title_icon', '`armese_about_title_icon`', '`armese_about_title_icon`', 200, -1, FALSE, '`armese_about_title_icon`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->fields['armese_about_title_icon'] = &$this->armese_about_title_icon;

		// armese_about_title
		$this->armese_about_title = new cField('armese_about', 'armese_about', 'x_armese_about_title', 'armese_about_title', '`armese_about_title`', '`armese_about_title`', 200, -1, FALSE, '`armese_about_title`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->fields['armese_about_title'] = &$this->armese_about_title;

		// armese_about_left_pic
		$this->armese_about_left_pic = new cField('armese_about', 'armese_about', 'x_armese_about_left_pic', 'armese_about_left_pic', '`armese_about_left_pic`', '`armese_about_left_pic`', 200, -1, TRUE, '`armese_about_left_pic`', FALSE, FALSE, FALSE, 'IMAGE', 'FILE');
		$this->fields['armese_about_left_pic'] = &$this->armese_about_left_pic;

		// armese_about_right_pic
		$this->armese_about_right_pic = new cField('armese_about', 'armese_about', 'x_armese_about_right_pic', 'armese_about_right_pic', '`armese_about_right_pic`', '`armese_about_right_pic`', 200, -1, TRUE, '`armese_about_right_pic`', FALSE, FALSE, FALSE, 'IMAGE', 'FILE');
		$this->fields['armese_about_right_pic'] = &$this->armese_about_right_pic;

		// armese_about_home_content
		$this->armese_about_home_content = new cField('armese_about', 'armese_about', 'x_armese_about_home_content', 'armese_about_home_content', '`armese_about_home_content`', '`armese_about_home_content`', 201, -1, FALSE, '`armese_about_home_content`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->fields['armese_about_home_content'] = &$this->armese_about_home_content;

		// armese_about_full_content
		$this->armese_about_full_content = new cField('armese_about', 'armese_about', 'x_armese_about_full_content', 'armese_about_full_content', '`armese_about_full_content`', '`armese_about_full_content`', 201, -1, FALSE, '`armese_about_full_content`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->fields['armese_about_full_content'] = &$this->armese_about_full_content;

		// armese_about_management_team_id
		$this->armese_about_management_team_id = new cField('armese_about', 'armese_about', 'x_armese_about_management_team_id', 'armese_about_management_team_id', '`armese_about_management_team_id`', '`armese_about_management_team_id`', 3, -1, FALSE, '`armese_about_management_team_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->armese_about_management_team_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['armese_about_management_team_id'] = &$this->armese_about_management_team_id;

		// status
		$this->status = new cField('armese_about', 'armese_about', 'x_status', 'status', '`status`', '`status`', 202, -1, FALSE, '`status`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`armese_about`";
	}
	...
	function DeleteSQL(&$rs, $where = "", $curfilter = TRUE) {
		...
		if (is_array($where))
			$where = $this->ArrayToFilter($where);
		if ($rs) {
			if (array_key_exists('armese_about_id', $rs))
				ew_AddFilter($where, ew_QuotedName('armese_about_id', $this->DBID) . '=' . ew_QuotedValue($rs['armese_about_id'], $this->armese_about_id->FldDataType, $this->DBID));
		}
		$filter = ($curfilter) ? $this->CurrentFilter : "";
		ew_AddFilter($filter, $where);
		if ($filter <> "")
	...
	function SqlKeyFilter() {
		return "`armese_about_id` = @armese_about_id@";
	}

	// Key filter
	function KeyFilter() {
		$sKeyFilter = $this->SqlKeyFilter();
		if (!is_numeric($this->armese_about_id->CurrentValue))
			$sKeyFilter = "0=1"; // Invalid key
		$sKeyFilter = str_replace("@armese_about_id@", ew_AdjustSql($this->armese_about_id->CurrentValue, $this->DBID), $sKeyFilter); // Replace key value
		return $sKeyFilter;
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("armese_aboutview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("armese_aboutview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "armese_aboutadd.php?" . $this->UrlParm($parm);
		else
			$url = "armese_aboutadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("armese_aboutedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("armese_aboutadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("armese_aboutdelete.php", $this->UrlParm());
	}
	...
	function KeyToJson() {
		$json = "";
		$json .= "armese_about_id:" . ew_VarToJson($this->armese_about_id->CurrentValue, "number", "'");
		return "{" . $json . "}";
	}
	...
	function KeyUrl($url, $parm = "") {
		$sUrl = $url . "?";
		if ($parm <> "") $sUrl .= $parm . "&";
		if (!is_null($this->armese_about_id->CurrentValue)) {
			$sUrl .= "armese_about_id=" . urlencode($this->armese_about_id->CurrentValue);
		} else {
	...
	function GetRecordKeys() {
		...
		if (isset($_POST["key_m"])) {
			...
			$arKeys[] = $isPost ? ew_StripSlashes(@$_POST["armese_about_id"]) : ew_StripSlashes(@$_GET["armese_about_id"]); // armese_about_id
	...
	function GetKeyFilter() {
		...
		foreach ($arKeys as $key) {
			...
			$this->armese_about_id->CurrentValue = $key;
   ...
   // Common render codes
	...
	function RenderEditRow() {
		...
		$this->armese_about_title_icon->EditValue = $this->armese_about_title_icon->CurrentValue;
		...
		$this->armese_about_title->EditValue = $this->armese_about_title->CurrentValue;
		...
		$this->armese_about_home_content->EditValue = $this->armese_about_home_content->CurrentValue;
		...
		$this->armese_about_full_content->EditValue = $this->armese_about_full_content->CurrentValue;
		...
		$this->armese_about_management_team_id->EditValue = $this->armese_about_management_team_id->CurrentValue;
		...
		if (!$Doc->ExportCustom) {
			...
			if ($Doc->Horizontal) { // Horizontal format, write header
				...
				if ($ExportPageType == "view") {
					if ($this->armese_about_id->Exportable) $Doc->ExportCaption($this->armese_about_id);
					if ($this->armese_about_title_icon->Exportable) $Doc->ExportCaption($this->armese_about_title_icon);
					if ($this->armese_about_title->Exportable) $Doc->ExportCaption($this->armese_about_title);
					if ($this->armese_about_left_pic->Exportable) $Doc->ExportCaption($this->armese_about_left_pic);
					if ($this->armese_about_right_pic->Exportable) $Doc->ExportCaption($this->armese_about_right_pic);
					if ($this->armese_about_home_content->Exportable) $Doc->ExportCaption($this->armese_about_home_content);
					if ($this->armese_about_full_content->Exportable) $Doc->ExportCaption($this->armese_about_full_content);
					if ($this->armese_about_management_team_id->Exportable) $Doc->ExportCaption($this->armese_about_management_team_id);
		...
		while (!$Recordset->EOF && $RecCnt < $StopRec) {
			...
			if (intval($RecCnt) >= intval($StartRec)) {
				...
				if (!$Doc->ExportCustom) {
					...
					if ($ExportPageType == "view") {
						if ($this->armese_about_id->Exportable) $Doc->ExportField($this->armese_about_id);
						if ($this->armese_about_title_icon->Exportable) $Doc->ExportField($this->armese_about_title_icon);
						if ($this->armese_about_title->Exportable) $Doc->ExportField($this->armese_about_title);
						if ($this->armese_about_left_pic->Exportable) $Doc->ExportField($this->armese_about_left_pic);
						if ($this->armese_about_right_pic->Exportable) $Doc->ExportField($this->armese_about_right_pic);
						if ($this->armese_about_home_content->Exportable) $Doc->ExportField($this->armese_about_home_content);
						if ($this->armese_about_full_content->Exportable) $Doc->ExportField($this->armese_about_full_content);
						if ($this->armese_about_management_team_id->Exportable) $Doc->ExportField($this->armese_about_management_team_id);
