...
fblogdelete.Lists["x_blog_category_id"] = {"LinkField":"x_blog_category_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_blog_category_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fblogdelete.Lists["x_status"] = {"LinkField":"","Ajax":false,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fblogdelete.Lists["x_status"].Options = <?php echo json_encode($blog->status->Options()) ?>;
...
<?php if ($blog->blog_id->Visible) { // blog_id ?>
		<th><span id="elh_blog_blog_id" class="blog_blog_id"><?php echo $blog->blog_id->FldCaption() ?></span></th>
<?php } ?>
<?php if ($blog->blog_title->Visible) { // blog_title ?>
		<th><span id="elh_blog_blog_title" class="blog_blog_title"><?php echo $blog->blog_title->FldCaption() ?></span></th>
<?php } ?>
<?php if ($blog->blog_pic->Visible) { // blog_pic ?>
		<th><span id="elh_blog_blog_pic" class="blog_blog_pic"><?php echo $blog->blog_pic->FldCaption() ?></span></th>
<?php } ?>
<?php if ($blog->blog_category_id->Visible) { // blog_category_id ?>
		<th><span id="elh_blog_blog_category_id" class="blog_blog_category_id"><?php echo $blog->blog_category_id->FldCaption() ?></span></th>
<?php } ?>
<?php if ($blog->status->Visible) { // status ?>
		<th><span id="elh_blog_status" class="blog_status"><?php echo $blog->status->FldCaption() ?></span></th>
<?php } ?>
<?php if ($blog->added_time->Visible) { // added_time ?>
		<th><span id="elh_blog_added_time" class="blog_added_time"><?php echo $blog->added_time->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<?php } ?>
<?php if ($blog->blog_title->Visible) { // blog_title ?>
		<td<?php echo $blog->blog_title->CellAttributes() ?>>
<span id="el<?php echo $blog_delete->RowCnt ?>_blog_blog_title" class="blog_blog_title">
...
<?php } ?>
<?php if ($blog->blog_pic->Visible) { // blog_pic ?>
		<td<?php echo $blog->blog_pic->CellAttributes() ?>>
<span id="el<?php echo $blog_delete->RowCnt ?>_blog_blog_pic" class="blog_blog_pic">
<span>
...
<?php } ?>
<?php if ($blog->blog_category_id->Visible) { // blog_category_id ?>
		<td<?php echo $blog->blog_category_id->CellAttributes() ?>>
<span id="el<?php echo $blog_delete->RowCnt ?>_blog_blog_category_id" class="blog_blog_category_id">
...
<?php } ?>
<?php if ($blog->status->Visible) { // status ?>
		<td<?php echo $blog->status->CellAttributes() ?>>
<span id="el<?php echo $blog_delete->RowCnt ?>_blog_status" class="blog_status">
...
<?php } ?>
<?php if ($blog->added_time->Visible) { // added_time ?>
		<td<?php echo $blog->added_time->CellAttributes() ?>>
<span id="el<?php echo $blog_delete->RowCnt ?>_blog_added_time" class="blog_added_time">
