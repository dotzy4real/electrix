...
$kilowatt_management_team_view = NULL; // Initialize page object first

class ckilowatt_management_team_view extends ckilowatt_management_team {
	...
	// Page object name
	var $PageObjName = 'kilowatt_management_team_view';
	...
	function __construct() {
		...
		if (@$_GET["kilowatt_management_team_id"] <> "") {
			$this->RecKey["kilowatt_management_team_id"] = $_GET["kilowatt_management_team_id"];
			$KeyUrl .= "&amp;kilowatt_management_team_id=" . urlencode($this->RecKey["kilowatt_management_team_id"]);
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["kilowatt_management_team_id"] <> "") {
				...
				$this->RecKey["kilowatt_management_team_id"] = $this->kilowatt_management_team_id->QueryStringValue;
			} elseif (@$_POST["kilowatt_management_team_id"] <> "") {
				$this->kilowatt_management_team_id->setFormValue($_POST["kilowatt_management_team_id"]);
				$this->RecKey["kilowatt_management_team_id"] = $this->kilowatt_management_team_id->FormValue;
			} else {
				$sReturnUrl = "kilowatt_management_teamlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "kilowatt_management_teamlist.php"; // No matching record, return to list
					}
			}
		} else {
			$sReturnUrl = "kilowatt_management_teamlist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($kilowatt_management_team_view)) $kilowatt_management_team_view = new ckilowatt_management_team_view();

// Page init
$kilowatt_management_team_view->Page_Init();

// Page main
$kilowatt_management_team_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$kilowatt_management_team_view->Page_Render();
?>
...
var CurrentForm = fkilowatt_management_teamview = new ew_Form("fkilowatt_management_teamview", "view");

// Form_CustomValidate event
fkilowatt_management_teamview.Form_CustomValidate = 
...
fkilowatt_management_teamview.ValidateRequired = true;
<?php } else { ?>
fkilowatt_management_teamview.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fkilowatt_management_teamview.Lists["x_status"] = {"LinkField":"","Ajax":false,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fkilowatt_management_teamview.Lists["x_status"].Options = <?php echo json_encode($kilowatt_management_team->status->Options()) ?>;
...
<?php $kilowatt_management_team_view->ExportOptions->Render("body") ?>
<?php
	foreach ($kilowatt_management_team_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php echo $Language->SelectionForm(); ?>
<div class="clearfix"></div>
</div>
<?php $kilowatt_management_team_view->ShowPageHeader(); ?>
<?php
$kilowatt_management_team_view->ShowMessage();
?>
<form name="fkilowatt_management_teamview" id="fkilowatt_management_teamview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($kilowatt_management_team_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $kilowatt_management_team_view->Token ?>">
<?php } ?>
...
<?php if ($kilowatt_management_team->kilowatt_management_team_id->Visible) { // kilowatt_management_team_id ?>
	<tr id="r_kilowatt_management_team_id">
		<td><span id="elh_kilowatt_management_team_kilowatt_management_team_id"><?php echo $kilowatt_management_team->kilowatt_management_team_id->FldCaption() ?></span></td>
...
<?php echo $kilowatt_management_team->kilowatt_management_team_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($kilowatt_management_team->kilowatt_management_team_pic->Visible) { // kilowatt_management_team_pic ?>
	<tr id="r_kilowatt_management_team_pic">
		<td><span id="elh_kilowatt_management_team_kilowatt_management_team_pic"><?php echo $kilowatt_management_team->kilowatt_management_team_pic->FldCaption() ?></span></td>
...
<span>
<?php echo ew_GetFileViewTag($kilowatt_management_team->kilowatt_management_team_pic, $kilowatt_management_team->kilowatt_management_team_pic->ViewValue) ?>
</span>
</span>
</td>
	</tr>
...
<?php if ($kilowatt_management_team->kilowatt_management_team_name->Visible) { // kilowatt_management_team_name ?>
	<tr id="r_kilowatt_management_team_name">
		<td><span id="elh_kilowatt_management_team_kilowatt_management_team_name"><?php echo $kilowatt_management_team->kilowatt_management_team_name->FldCaption() ?></span></td>
...
<?php echo $kilowatt_management_team->kilowatt_management_team_name->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($kilowatt_management_team->kilowatt_management_team_designation->Visible) { // kilowatt_management_team_designation ?>
	<tr id="r_kilowatt_management_team_designation">
		<td><span id="elh_kilowatt_management_team_kilowatt_management_team_designation"><?php echo $kilowatt_management_team->kilowatt_management_team_designation->FldCaption() ?></span></td>
...
<?php echo $kilowatt_management_team->kilowatt_management_team_designation->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($kilowatt_management_team->kilowatt_management_team_content->Visible) { // kilowatt_management_team_content ?>
	<tr id="r_kilowatt_management_team_content">
		<td><span id="elh_kilowatt_management_team_kilowatt_management_team_content"><?php echo $kilowatt_management_team->kilowatt_management_team_content->FldCaption() ?></span></td>
		<td data-name="kilowatt_management_team_content"<?php echo $kilowatt_management_team->kilowatt_management_team_content->CellAttributes() ?>>
<span id="el_kilowatt_management_team_kilowatt_management_team_content">
<span<?php echo $kilowatt_management_team->kilowatt_management_team_content->ViewAttributes() ?>>
<?php echo $kilowatt_management_team->kilowatt_management_team_content->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($kilowatt_management_team->sort_order->Visible) { // sort_order ?>
	<tr id="r_sort_order">
		<td><span id="elh_kilowatt_management_team_sort_order"><?php echo $kilowatt_management_team->sort_order->FldCaption() ?></span></td>
...
<?php echo $kilowatt_management_team->sort_order->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($kilowatt_management_team->status->Visible) { // status ?>
	<tr id="r_status">
		<td><span id="elh_kilowatt_management_team_status"><?php echo $kilowatt_management_team->status->FldCaption() ?></span></td>
...
<?php echo $kilowatt_management_team->status->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($kilowatt_management_team->kilowatt_management_team_linkedin->Visible) { // kilowatt_management_team_linkedin ?>
	<tr id="r_kilowatt_management_team_linkedin">
		<td><span id="elh_kilowatt_management_team_kilowatt_management_team_linkedin"><?php echo $kilowatt_management_team->kilowatt_management_team_linkedin->FldCaption() ?></span></td>
...
<?php echo $kilowatt_management_team->kilowatt_management_team_linkedin->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($kilowatt_management_team->kilowatt_management_team_facebook->Visible) { // kilowatt_management_team_facebook ?>
	<tr id="r_kilowatt_management_team_facebook">
		<td><span id="elh_kilowatt_management_team_kilowatt_management_team_facebook"><?php echo $kilowatt_management_team->kilowatt_management_team_facebook->FldCaption() ?></span></td>
...
<?php echo $kilowatt_management_team->kilowatt_management_team_facebook->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($kilowatt_management_team->kilowatt_management_team_twitter->Visible) { // kilowatt_management_team_twitter ?>
	<tr id="r_kilowatt_management_team_twitter">
		<td><span id="elh_kilowatt_management_team_kilowatt_management_team_twitter"><?php echo $kilowatt_management_team->kilowatt_management_team_twitter->FldCaption() ?></span></td>
...
<?php echo $kilowatt_management_team->kilowatt_management_team_twitter->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($kilowatt_management_team->kilowatt_management_team_email->Visible) { // kilowatt_management_team_email ?>
	<tr id="r_kilowatt_management_team_email">
		<td><span id="elh_kilowatt_management_team_kilowatt_management_team_email"><?php echo $kilowatt_management_team->kilowatt_management_team_email->FldCaption() ?></span></td>
...
<?php echo $kilowatt_management_team->kilowatt_management_team_email->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($kilowatt_management_team->kilowatt_management_team_phone->Visible) { // kilowatt_management_team_phone ?>
	<tr id="r_kilowatt_management_team_phone">
		<td><span id="elh_kilowatt_management_team_kilowatt_management_team_phone"><?php echo $kilowatt_management_team->kilowatt_management_team_phone->FldCaption() ?></span></td>
...
<?php echo $kilowatt_management_team->kilowatt_management_team_phone->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<script type="text/javascript">
fkilowatt_management_teamview.Init();
</script>
<?php
$kilowatt_management_team_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$kilowatt_management_team_view->Page_Terminate();
?>
